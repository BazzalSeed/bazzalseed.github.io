...
const en: SiteContent = {
  ...
  roles: [
    ...
    { title: 'Founding Engineer', org: 'Klaviyo', logo: 'klaviyo', period: 'Apr 2017 — Jul 2019',
    ...
    { title: 'Backend Software Engineer', org: 'SurveyMini', logo: 'surveymini', period: 'Jul 2016 — Mar 2017',
...
const zh: SiteContent = {
  ...
  roles: [
    ...
    { title: '主管工程师', org: 'Meta', logo: 'meta', period: '2020年8月 — 2022年10月',
    ...
    { title: '早期核心工程师', org: 'Klaviyo', logo: 'klaviyo', period: '2017年4月 — 2019年7月',
    ...
    { title: '后端软件工程师', org: 'SurveyMini', logo: 'surveymini', period: '2016年7月 — 2017年3月',
      summary: '负责问卷平台后端、数据系统与 AWS 数据架构建设。',
      notes: [
